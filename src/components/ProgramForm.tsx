...
import { GraduationCap, Building2, Tag, Clock, DollarSign, BarChart3, Monitor, FileText, ListChecks, X } from 'lucide-react'
...
export default function ProgramForm({ institutions, categories, onSubmit, onClose }: ProgramFormProps) {
