    ...
    <main className='min-h-screen'>
      <section className='relative py-20 px-4 bg-gradient-to-b from-elimux-dark to-elimux-card'>
        <div className='max-w-6xl mx-auto text-center'>
          ...
          <h1 className='text-balance text-4xl md:text-6xl font-bold text-foreground mb-4 leading-tight'>
            Discover Your Perfect{' '}
            <span className='text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-primary-600'>
              Education
            </span>
          </h1>
          <p className='text-balance text-lg md:text-xl text-muted mb-10 max-w-2xl mx-auto'>
          ...
          <div className='flex flex-wrap items-center justify-center gap-2 mt-4 text-sm'>
            ...
            {EXAMPLE_SEARCHES.map((example) => (
              <button
                ...
                className='px-3 py-1 rounded-full bg-elimux-card border border-border text-muted hover:text-primary-400 hover:border-primary-500/50 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background'
              >
                {example}
              </button>
            ))}
          ...
          <div className='flex flex-col sm:flex-row items-center justify-center gap-4 mt-6'>
            <Link
              href='/programs'
              className='inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-primary-500 text-white font-medium shadow-soft hover:shadow-soft-lg hover:bg-primary-600 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background'
            >
            ...
            <Link
              href='/ai-search'
              className='inline-flex items-center gap-2 text-sm font-medium text-primary-400 hover:text-primary-300 transition-colors rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background'
            >
              <Sparkles className='w-4 h-4' />
        ...
        <div className='max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6'>
          {stats.map((stat, index) => (
            <div key={index} className='text-center animate-fade-in'>
              ...
              <p className='text-display-2 font-bold text-foreground'>{stat.value}</p>
      ...
      {hasSearched && (
        <section className='py-12 px-4 max-w-6xl mx-auto'>
          {loading ? (
            <div className='text-center py-12' role='status' aria-label='Searching'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4'>
              {categories.slice(0, 10).map((cat) => (
                <button
                  ...
                  className='p-4 rounded-xl bg-elimux-card border border-border shadow-card hover:shadow-card-hover hover:border-primary-500/50 hover:-translate-y-0.5 transition-all text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background'
                >
