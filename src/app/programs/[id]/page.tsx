    ...
    <main className="min-h-screen py-12 px-4">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-elimux-card rounded-2xl p-6 md:p-8 border border-border">
          ...
          {program.is_ai_generated && !program.is_verified && (
            <div className="flex items-start gap-2 mb-6 p-3 rounded-lg bg-warning/10 text-warning text-sm">
              <Sparkles className="w-4 h-4 flex-shrink-0 mt-0.5" />
              <p>
                This program information was generated by AI and may not be fully accurate. Please
                verify with the university before applying.
              </p>
            </div>
          )}
