// src/app/institution/dashboard/link-performance/page.tsx
// Shows an institution how its own smart links (shared listings) are performing
// Renamed from "Analytics" (Cycle 177-B) to avoid colliding with the main
// dashboard's own "Analytics" tab, which tracks different, institution-wide
// metrics - this page only ever covered one user's own smart-link clicks.
//
...
export default function InstitutionLinkPerformancePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Link Performance</h1>
