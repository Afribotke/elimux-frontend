...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/programs/`, lastModified: new Date(), changeFrequency: "daily", priority: 0.9 },
    ...
    { url: `${baseUrl}/attachments/`, lastModified: new Date(), changeFrequency: "daily", priority: 0.9 },
    { url: `${baseUrl}/bursary/`, lastModified: new Date(), changeFrequency: "daily", priority: 0.9 },
    { url: `${baseUrl}/institutions/`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.8 },
