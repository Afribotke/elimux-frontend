...
export default function AboutPage() {
  ...
  return (
    <main className='min-h-screen py-12 px-4 max-w-4xl mx-auto'>
      ...
      <div className='bg-elimux-card rounded-2xl p-8 mb-12 border border-gray-700/50'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-12'>
        {values.map((value, index) => (
          <div key={index} className='bg-elimux-card rounded-xl p-5 border border-gray-700/50'>
      ...
      <div className='bg-gradient-to-r from-primary-600/20 to-primary-800/20 rounded-2xl p-8 border border-primary-500/20 text-center'>
        ...
        <p className='text-gray-400 mb-6'>Be part of the growing network of students and institutions on ElimuX.</p>
        <div className='grid grid-cols-3 gap-4'>
          <div><p className='text-3xl font-bold text-primary-400'>100+</p><p className='text-sm text-gray-400'>Countries</p></div>
          <div><p className='text-3xl font-bold text-primary-400'>20+</p><p className='text-sm text-gray-400'>Categories</p></div>
          <div><p className='text-3xl font-bold text-primary-400'>15+</p><p className='text-sm text-gray-400'>Institution Types</p></div>
        </div>
      </div>
    </main>
  )
