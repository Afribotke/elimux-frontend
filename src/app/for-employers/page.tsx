...
export default function ForEmployersPage() {
  return (
    <div className="min-h-screen bg-muted">
      ...
      <section className="bg-blue-600 py-16 px-4 text-center">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          <Link
            ...
            className="rounded-lg bg-background px-6 py-3 text-sm font-semibold text-blue-600 hover:bg-blue-50"
          >
            Register as Employer
          </Link>
          <Link
            href="/internships"
            className="rounded-lg border border-white px-6 py-3 text-sm font-semibold text-white hover:bg-background/10"
          >
            Browse Listings
          </Link>
        </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16">
        <div className="grid gap-8 sm:grid-cols-3">
          {[
            ...
            <div key={f.title} className="rounded-xl bg-background p-6 shadow-sm border border-border">
      ...
      {/* CTA */}
      <section className="bg-background border-t border-border py-16 px-4 text-center">
        <h2 className="text-2xl font-bold text-foreground">Ready to start hiring?</h2>
        <p className="mt-2 text-muted-foreground">Join hundreds of employers already using ElimuX.</p>
        <Link
          href="/employer/register"
