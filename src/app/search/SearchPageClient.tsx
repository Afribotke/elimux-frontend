...
function SearchResults() {
  ...
  const shareData = query.trim()
    ? {
        title: `Search: "${query}" on ElimuX`,
        description: `Find scholarships, programs, and institutions matching "${query}" on ElimuX.`,
    ...
    : getDefaultShareData('/search', 'search');
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-5xl mx-auto px-4 py-8">
        <div className="flex items-start justify-between gap-4 mb-2">
          ...
          {query.trim() && <ShareButton shareData={shareData} variant="icon-only" />}
        </div>
