...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "AI-powered education and career discovery. Find universities, TVET programs, scholarships, internships, and attachments.",
    images: [{
      url: "/og-image.png",
      width: 1200,
      height: 630,
  ...
  twitter: {
    ...
    title: "ElimuX — Discover Your Perfect Education & Career",
    description: "AI-powered education and career discovery platform.",
    images: ["/og-image.png"],
  },
  robots: {
    index: true,
