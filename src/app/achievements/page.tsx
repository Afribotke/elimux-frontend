    ...
    <div className="min-h-screen bg-muted">
      ...
      <section className="bg-amber-500 py-16 px-4 text-center">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          <Link
            href="/gamification"
            className="rounded-lg bg-background px-6 py-3 text-sm font-semibold text-amber-600 hover:bg-amber-50"
          >
            View Leaderboard
          </Link>
          <Link
      ...
      <section className="mx-auto max-w-6xl px-4 py-16">
        <div className="grid gap-8 sm:grid-cols-3">
          {[
            ...
            <div key={b.title} className="rounded-xl bg-background p-6 shadow-sm border border-border text-center">
      ...
      <section className="bg-background border-t border-border py-16 px-4 text-center">
        ...
        <p className="mt-2 text-muted-foreground">Every action on ElimuX brings you closer to rewards.</p>
        <Link
          href="/gamification"
