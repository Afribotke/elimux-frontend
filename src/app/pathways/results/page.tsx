...
// Static metadata rather than the prior dynamic career/fit-based version -
// this page now always renders Coming Soon regardless of query params, so
// a social preview still saying "I'm 88% match for Lawyer" would actively
// contradict the page it links to.
export const metadata: Metadata = {
  title: 'Career Pathways — Coming Soon',
  description: "We're aligning our recommendation engine with the official KEMIS Grade 10 selection framework. This feature will be available soon.",
};

export default function PathwaysResultsComingSoonPage() {
  return (
